...
define([], function() {
    ...
    return /** @lends module:util/type.prototype */{
        ...
        isDefined: function(arg) {
            if (arg === undefined || (typeof arg === "number" && (isNaN(Number.parseFloat(arg)) || Math.abs(arg) === Infinity))) {
                return false;
            }
            return true;
        },
        ...
        isInitialized: function(arg) {
            // see also isDefined()
            if (arg === null || arg === undefined || (typeof arg === "number" && (isNaN(Number.parseFloat(arg)) || Math.abs(arg) === Infinity))) {
                return false;
            }
            return true;
        },
